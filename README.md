...
as the abilities themselves. Anyone without it who runs `/nexusadmin` still gets the plain usage
text, same as before this menu existed.
...
Produces `target/NexusAdmin-0.2.0.jar`. Requires Java 21 and network access to `repo.papermc.io` /
